...
#' @slot knots An object of class \code{numeric}, describing the boundaries of the splines.
...
#' @slot modelsUsed A vector of class \code{numeric}, describing the polynomial boundaries of the splines. If not defined or if basis='cubic' knots are automatically estimated using Ruppert 2002 or are the design points when using 'cubic'. 
#' @slot models A \code{list} of class \code{lm} or \code{lme}, containing the models used to model the particular feature of interest. 
#' @slot data A \code{data.frame} containing the data used to model the particular molecule of interest. 
...
setClass("lmmspline",slots= c(predSpline="data.frame", modelsUsed="numeric",models="list",data='data.frame',derivative='logical'),contains='lmms')
